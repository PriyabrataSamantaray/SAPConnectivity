...
namespace dbaccess
{
    public class BulkSQL
    {
        ...
        public BulkSQL(string ConnString, List<string> Headings, List<string> DataTypes)
        {
            ...
            BulkCopy = new SqlBulkCopy(ConnString);
        ...
        public BulkSQL(string ConnString, DataTable Source)
        {
            TempData = Source;
